!function(){
	var bP={};	
	var b=30, bb=250, height=900, buffMargin=1, minHeight=14;
	var c1=[-200, 40], c2=[-50, 200], c3=[-10, 240]; //Column positions of labels.
	...
	function drawHeader(header, id){
		d3.select("#"+id).append("g").attr("class","header").append("text").text(header[2])
			.style("font-size","20").attr("x",108).attr("y",-50).style("text-anchor","middle")
